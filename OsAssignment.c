...
int main()
{
    ...
    for(int i=0;i<size;i++)
    {
        temp_burst[i] = no[i].burst_time;     //storing the value of  burst time in an array for  further use.
    }

    no[size+1].burst_time = 999;     //  assign maximum burst time  for comparison.
